...
2. Upload the mzc_landing_newsletter folder to your PrestaShop's modules directory via FTP
...
PrestaShop saves the translation file to modules/mzc_landing_newsletter/translations/ automatically.
