...
2. Carica la cartella mzclandingnewsletter nella directory modules del tuo PrestaShop via FTP
...
PrestaShop salva automaticamente il file di traduzione in modules/mzclandingnewsletter/translations/.
